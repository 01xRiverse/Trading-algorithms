...
We enter a short trade when 21 EMA overtakes 9 EMA and the MACD values are below 0.
...
Since CCXTs limit is a 1000 candles, i cant test this strategy on a bigger scale.
Since this Strategy worked, i will develop a script to connect directly to an exchange and start executing trades.
